...
0:00–0:25 · Problem
"Meet Maya, a second-year at UCL. Her sleep is wrecked. Her resting heart rate has climbed all week. Her HRV is dropping. Her smartwatch sees the pattern. Maya doesn't. So nothing happens.
...
0:25–0:50 · Core idea
"BodyCheck is an early-warning and care-routing layer for university students. It turns wearable patterns and quick symptom check-ins into one thing Maya can act on: her body state right now. Not a diagnosis. Not another score. One state, one reason, one next step.
...
Day six: the pattern persists and Maya logs a symptom. Action Needed. It routes her to NHS 111, her GP, or university wellbeing. That is the gap. Wearables stop at insight. BodyCheck turns insight into routing.
Now the safety bypass. If Maya logs chest pain or severe difficulty breathing, it does not wait for a trend. It jumps straight to Action Needed and signposts urgent care. The wearable does not detect the emergency. The check-in does. That is deliberate.
